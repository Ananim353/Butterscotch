...
static void parseCommandLineArgs(CommandLineArgs* args, int argc, char* argv[]) {
    ...
    static struct option longOptions[] = {
        ...
        // Equal-depth instances draw in creation order. A/B switch: at equal depth the inherited
        // rule draws the NEWEST instance first, i.e. behind everything older, which hides effects
        // spawned at runtime behind scenery that shares their depth. See compareDrawKeys.
